 ...
 * just a request to the URL the form is already at. A form is always submitted
 * and says so by returning a handler, while a page is only
 * sometimes (a dashboard reads, a settings page saves) and answers null until it
 * is given one, which is what keeps the extra route off every page that has
 * nothing to receive.
 */
